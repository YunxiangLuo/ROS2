...
# ============================================================
# SLAM 建图启动脚本
# 用于 ROS2 Humble + slam_toolbox 在线建图
...
ros2 launch robot_sim_demo_ros2 gazebo_sim.launch.py &
GAZEBO_PID=$!
...
echo ""
echo "  2. 可视化建图过程:"
echo "     rviz2 -d src/slam_sim_demo_ros2/rviz/slam_demo.rviz"
echo ""
echo "  3. 保存地图:"
