...
ROS_WS="${ROS_WS:-$HOME/ros2_autonomous_driving}"
TOWN="Town03"
WEATHER="default"
...
usage() {
    ...
    echo "  --ros-ws PATH        ROS2工作空间路径 (默认: ~/ros2_autonomous_driving)"
...
start_autonomous_driving() {
    ...
    LAUNCH_CMD="ros2 launch autonomous_driving_bringup start_driving.launch.py town:=$TOWN traffic_density:=$TRAFFIC_DENSITY"
...
start_visualization() {
    ...
    RVIZ_CONFIG="$ROS_WS/src/autonomous_driving_bringup/config/driving.rviz"
...
main() {
    echo -e "${CYAN}╔═══════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║   第45章 城区自动驾驶综合项目 Demo       ║${NC}"
    ...
    echo
    echo -e "${GREEN}╔═══════════════════════════════════════════╗${NC}"
    echo -e "${GREEN}║    所有模块已启动                        ║${NC}"
    echo -e "${GREEN}║    等待自动驾驶开始...                   ║${NC}"
    echo -e "${GREEN}╚═══════════════════════════════════════════╝${NC}"
    echo
