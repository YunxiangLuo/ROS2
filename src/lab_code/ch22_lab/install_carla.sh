...
if [ ! -f "CARLA_${CARLA_VERSION}.tar.gz" ]; then
    wget "https://carla-releases.s3.eu-west-3.amazonaws.com/Linux/CARLA_${CARLA_VERSION}.tar.gz"
else
...
if [ ! -f "AdditionalMaps_${CARLA_VERSION}.tar.gz" ]; then
    wget "https://carla-releases.s3.eu-west-3.amazonaws.com/Linux/AdditionalMaps_${CARLA_VERSION}.tar.gz"
fi
